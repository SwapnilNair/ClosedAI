...
const version = "16.0.0-canary.11";
window.next = {
    version,
    appDir: true
};
...
async function fetchServerResponse(url, options) {
   ...
   */ if (prefetchKind === _routerreducertypes.PrefetchKind.AUTO) {
    ...
    try {
        ...
        return {
            flightData: (0, _flightdatahelpers.normalizeFlightData)(flightResponse.f),
...
"[project]/node_modules/next/dist/client/components/segment-cache-impl/tuple-map.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const _routeparams = __turbopack_context__.r("[project]/node_modules/next/dist/client/route-params.js [app-client] (ecmascript)");
const _tuplemap = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/segment-cache-impl/tuple-map.js [app-client] (ecmascript)");
...
function listenForDynamicRequest(task, responsePromise) {
    responsePromise.then(({ flightData, debugInfo })=>{
        if (typeof flightData === 'string') {
...
function createPendingCacheNode(navigatedAt, routerState, prefetchData, prefetchHead, isPrefetchHeadPartial, segmentPath, scrollableSegmentsResult) {
    ...
    return {
        ...
        loading: prefetchData !== null ? prefetchData[3] ?? null : createDeferredRsc(),
        navigatedAt
    };
}
...
function navigate(url, currentUrl, currentCacheNode, currentFlightRouterState, nextUrl, shouldScroll, accumulation) {
    ...
    if (route !== null && route.status === _cache.EntryStatus.Fulfilled) {
        ...
        return navigateUsingPrefetchedRouteTree(now, url, currentUrl, nextUrl, isSamePageNavigation, currentCacheNode, currentFlightRouterState, prefetchFlightRouterState, prefetchSeedData, prefetchHead, isPrefetchHeadPartial, newCanonicalUrl, shouldScroll, url.hash);
    }
...
function navigateUsingPrefetchedRouteTree(now, url, currentUrl, nextUrl, isSamePageNavigation, currentCacheNode, currentFlightRouterState, prefetchFlightRouterState, prefetchSeedData, prefetchHead, isPrefetchHeadPartial, canonicalUrl, shouldScroll, hash) {
...
async function navigateDynamicallyWithNoPrefetch(now, url, currentUrl, nextUrl, isSamePageNavigation, currentCacheNode, currentFlightRouterState, shouldScroll, hash, collectedDebugInfo) {
    ...
    const { flightData, canonicalUrl: canonicalUrlOverride, debugInfo: debugInfoFromResponse } = await promiseForDynamicServerResponse;
 ...
 */ function Router({ actionQueue, globalError, webSocket, staticIndicatorState }) {
    ...
    (0, _react.useEffect)(()=>{
        ...
        const applyUrlFromHistoryPushReplace = (url)=>{
            ...
            const tree = window.history.state?.__PRIVATE_NEXTJS_INTERNALS_TREE;
            (0, _react.startTransition)(()=>{
                (0, _useactionqueue.dispatchAppRouterAction)({
                    type: _routerreducertypes.ACTION_RESTORE,
...
function refreshReducer(state, action) {
    ...
    return cache.lazyData.then(async ({ flightData, canonicalUrl: canonicalUrlOverride })=>{
        // Handle case when navigating to page in `pages` from `app`
        if (typeof flightData === 'string') {
            return (0, _navigatereducer.handleExternalUrl)(state, mutable, flightData, state.pushRef.pendingPush);
        }
...
function hmrRefreshReducerImpl(state, action) {
    ...
    return cache.lazyData.then(({ flightData, canonicalUrl: canonicalUrlOverride })=>{
        // Handle case when navigating to page in `pages` from `app`
        if (typeof flightData === 'string') {
            return (0, _navigatereducer.handleExternalUrl)(state, mutable, flightData, state.pushRef.pendingPush);
        }
...
const _refetchinactiveparallelsegments = __turbopack_context__.r("[project]/node_modules/next/dist/client/components/router-reducer/refetch-inactive-parallel-segments.js [app-client] (ecmascript)");
const _flightdatahelpers = __turbopack_context__.r("[project]/node_modules/next/dist/client/flight-data-helpers.js [app-client] (ecmascript)");
function createInitialRouterState({ navigatedAt, initialFlightData, initialCanonicalUrlParts, initialParallelRoutes, location }) {
...
function ServerRoot({ pendingActionQueue, webSocket, staticIndicatorState }) {
...
//# sourceMappingURL=node_modules_next_dist_client_779bced7._.js.map